...
/// Retrieves the first scheduled time of the current task
...
/// Checks if a contiguous virtual memory area can be allocated for the current task
...
/// Creates a new contiguous memory area
...
/// Releases a contiguous memory area
